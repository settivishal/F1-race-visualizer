  ...
  return (
    <PageContainer>
      ...
      <Section title="Where the data comes from">
        ...
        <p>
          No team logo is shown anywhere on the site. Roughly half the grid&rsquo;s marks are
          figurative and copyrighted — Wikimedia Commons does not carry Ferrari&rsquo;s at
          all — so the season strip abbreviates a team rather than badging it.
        </p>
      </Section>
